...
class LikedMemoScreen extends StatefulWidget {
  @override
  _LikedMemoScreenState createState() => _LikedMemoScreenState();
}

class _LikedMemoScreenState extends State<LikedMemoScreen> {
  ...
  void _loadUserAndMemos() {
    ...
    // 초기 메모 목록 로드
    _memos = _memoListService.fetchLikedMemos();
  }
